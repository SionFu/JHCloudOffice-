...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _itemTitleColor = [UIColor colorWithRed:0.5944 green:0.5916 blue:0.5973 alpha:1.0];
        _itemSelectedTitleColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.0];
...
//      NSLog(@"retio : %f,%f",_indicatorView.frame.origin.x,indicatorX);
}
